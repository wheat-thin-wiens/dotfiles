...
vim.keymap.set('n', '<C-p>', function() builtin.find_files { cwd = vim.fn.getcwd(), prompt_title = vim.fn.getcwd() } end, {})
...
vim.keymap.set('n', '<leader>u',':Telescope undo <CR>', {desc = "[U]ndo"})
